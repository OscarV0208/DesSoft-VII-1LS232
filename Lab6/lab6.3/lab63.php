...
$soporte1 = new soporte("The Soccer Game",22,3); echo "<b>" . $soporte1->titulo . "</b>";
...
$mivideo = new video("Los Otros", 22, 4.5, "115 minutos"); echo "<br><br>";
echo "<b>" . $mivideo->titulo . "</b>";
echo "<br>Precio: " . $mivideo->dame_precio_sin_itbm(). " dolares";
 
echo "<br>Precio ITBM incluido: " . $mivideo->dame_precio_con_itbm() . " dolares "; echo "<br>" . $mivideo->imprime_caracteristicas();
...
$mijuego->imprime_jugadores_posibles(); echo "<p>";
$mijuego2 = new juego("Fifa 18", 27, 3, "PS 4",1,2); echo "<b>" . $mijuego2->titulo . "</b>";
